            ...
            <div class="modal-body">
                ...
                <div class="custom-gridview-container">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="gvBatchDetails" runat="server" AutoGenerateColumns="False" CssClass="custom-gridview-modal" OnRowCommand="gvBatchDetails_RowCommand" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="QR Code">
                                        <ItemTemplate>
                                            <asp:Image ID="qrCodeImage" runat="server" ImageUrl='<%# "~/App_Data/QRCodeImages/DA790A47DB6C.jpg" %>' AlternateText="QR Code" Style="width: 20px; height: 20px;" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Generate Publisher">
                                        <ItemTemplate>
                                           <asp:Button ID="GeneratePublisherButton" runat="server" CommandName="GeneratePublisher" CommandArgument='<%# Container.DataItemIndex %>' Text="Generate Publisher" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <PagerSettings Visible="false" />
...
<i class='bx bx-chevron-right'></i>
            ...
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="closeModal()">Close</button>
                <asp:Button ID="btnDownloadAll" runat="server" CssClass="btn btn-primary" Text="Download All" OnClick="btnDownloadAll_Click" />
            </div>
        </div>
    </div>
</div>
