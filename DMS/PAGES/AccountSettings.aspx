    ...
    <div class="main">
        ...
        <div class="custom-gridview-container shadow-sm">
            ...
            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                <asp:RadioButton ID="perUser" runat="server" GroupName="btnGroupRadio" Text="Per user" AutoPostBack="true" OnCheckedChanged="RadioButton_CheckedChanged" Checked="true" />
                <asp:RadioButton ID="byPosition" runat="server" GroupName="btnGroupRadio" Text="By Position" AutoPostBack="true" OnCheckedChanged="RadioButton_CheckedChanged" />
            </div>
            ...
            <div class="table-responsive">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="custom-gridview" AutoGenerateColumns="false"
                    AllowPaging="true" PageSize="5" Visible="true"
                    DataKeyNames="UserID">
                    <Columns>
                        <%-- Name --%>
            ...
            <!--PAGINATION PER USER-->
            <nav id="paginationPerUser" runat="server" aria-label="Page navigation" class="custom-pagination" visible="true">
                <ul class="pagination">
                    <div class="page-cont">
            ...
            <!-- Table Card BY POSITION -->
            <div class="table-responsive">
                <asp:GridView ID="GridViewByPosition" runat="server" CssClass="custom-gridview" AutoGenerateColumns="false"
                    AllowPaging="true" PageSize="5" Visible="false"
                    DataKeyNames="UserID">
                    <Columns>
                        <%-- Name --%>
                        <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
            ...
            <nav id="paginationByPosition" runat="server" aria-label="Page navigation" class="custom-pagination" visible="false">
                <ul class="pagination">
                    <div class="page-cont">
                        <span>Go to page:</span>
                        <asp:TextBox ID="txtPageNumberPosition" runat="server" CssClass="form-control search-num" Width="30px" AutoPostBack="true" OnTextChanged="txtPageNumberPosition_TextChanged"></asp:TextBox>
                        &nbsp;
                    </div>
                </ul>
                <ul class="pagination">
                    <div class="page-cont">
                        <li class="page-item">
                            <asp:LinkButton ID="btnPrevPosition" runat="server" CssClass="page-link" OnClick="btnPrevPosition_Click" aria-label="Previous">
        <i class='bx bx-chevron-left'></i>
                            </asp:LinkButton>
                        </li>
                        <span class="page-of">Page
     <asp:Label ID="lblPageNumPosition" runat="server"></asp:Label>
                            of
    <asp:Label ID="lblTotalPagesPosition" runat="server"></asp:Label>
                        </span>

                        <li class="page-item">
                            <asp:LinkButton ID="btnNextPosition" runat="server" CssClass="page-link" OnClick="btnNextPosition_Click" aria-label="Next">
        <i class='bx bx-chevron-right'></i>
                            </asp:LinkButton>
                        </li>
