<%@ Page Title="" Language="C#" MasterPageFile="~/PAGES/topnav.Master" AutoEventWireup="true" CodeBehind="Help.aspx.cs" Inherits="DMS.MIS.Help" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            <h1 class="h1 mb-0 text-gray-800">Test Camera Upload</h1>
        </div>
            ...
            <div class="doc-infor">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body file-info-box">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm">
                                <asp:Button ID="btnUpload" runat="server" Text="Upload" class="btn btn-sm upload-file" OnClick="btnUpload_Click" />
                                <asp:Button ID="btnScan" runat="server" Text="Scan" class="btn btn-sm scan-file" OnClick="btnScan_Click" />
                                <asp:Button ID="btnOpenCamera" runat="server" Text="Camera" CssClass="btn btn-sm camera-file" OnClick="btnOpenCamera_Click" />
                                <asp:Button ID="btnCloseScanCamera" runat="server" Text="Close Camera" CssClass="btn btn-sm camera-file" Visible="false" OnClick="btnCloseScanCamera_Click" />

                                <asp:Button ID="btnCaptureFileScan" runat="server" Text="Capture" CssClass="btn btn-sm camera-file" Visible="false" OnClick="btnCaptureFileScan_Click"/>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm">
                                ...
                                <div class="full-document-section" id="ocrSection" <%--style="display: none;--%>">
                                    <h2>OCR Text</h2>
                                    <textarea class="full-document" id="ocrTextArea" style="width: 100%; height: 135px;" runat="server"></textarea>
                                </div>
